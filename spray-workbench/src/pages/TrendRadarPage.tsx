...
export function TrendRadarPage() {
  ...
  const byGroup = (group: "model-ranking" | "market-validation" | "social-signal") => shortcuts.filter((shortcut) => "group" in shortcut && shortcut.group === group && shortcut.id !== "amazon-demand");
