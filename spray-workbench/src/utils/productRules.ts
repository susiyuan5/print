...
export function opportunityScore(product: ProductOpportunity) {
  if (["blocked"].includes(product.ipRisk) || ["blocked"].includes(product.complianceRisk) || product.licenseStatus === "personal-use-only") return 0;
